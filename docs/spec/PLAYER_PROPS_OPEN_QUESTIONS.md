...
- Full `__sendLogin` emission needs every `getProp` case implemented and fixture-tested.
...
- The complete `__sendLogin` table should be represented as a tested constant before full login property emission is enabled.
